<div class="content has-text-centered pt-5 mx-6">
	<h1 class="is-family-sans-serif has-text-weight-bold grey-dark">
		About Momus.io
	</h1>
	<p>
		Who's Momus? He's the Greek god of sarcasm. Maybe not the best figure to
		name a site after, but here we are.
	</p>
	<p>
	...
	<p>
		...
		frontend, Node and Express on the backend, and PostgreSQL and Prisma for the
		database layer.
	</p>
</div>
